...
const ProductCard: React.FC<ProductCard> = ({ data}) => {
    ...
    return (
        <div onClick={handleClick} className="bg-white group cursor-pointer rounded-xl border hover:border-gray-900 transition p-3 space-y-4">
            {/* Images & Actions */ }
            <div className="aspect-square rounded-xl bg-gray-100 relative">
                <Image src={data?.images?.[0]?.url} fill alt="Product Image" className='aspect-square object-cover rounded-md' />
